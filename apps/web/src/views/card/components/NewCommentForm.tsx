...
const NewCommentForm = ({ cardPublicId }: { cardPublicId: string }) => {
  ...
  return (
    <form
      ...
      className="flex w-full max-w-[800px] flex-col rounded-xl border border-light-600 bg-light-200 p-4 text-light-900 focus-visible:outline-none dark:border-dark-400 dark:bg-dark-100 dark:text-dark-1000 sm:text-sm sm:leading-6"
    >
      <ContentEditable
